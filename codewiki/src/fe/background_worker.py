...
class BackgroundWorker:
    ...
    def __init__(self, cache_manager: CacheManager, temp_dir: str | None = None):
        self.cache_manager = cache_manager
        self.temp_dir = temp_dir or WebAppConfig.TEMP_DIR
        self.running = False
        self.processing_queue: Queue[str] = Queue(maxsize=WebAppConfig.QUEUE_SIZE)
    ...
    def add_job(self, job_id: str, job: JobStatus) -> None:
    ...
    def _reconstruct_jobs_from_cache(self) -> None:
    ...
    def save_job_statuses(self) -> None:
    ...
    def _process_job(self, job_id: str) -> None:
        ...
        try:
            ...
            # Generate documentation
            doc_generator = DocumentationGenerator(config, job.commit_id or "")
