...
class TreeSitterJSAnalyzer:
    def __init__(self, file_path: str, content: str, repo_path: str | None = None):
        ...
        self.seen_relationships: set[tuple[str, str, int | None]] = set()
        self.parser: Parser | None = None
        self.js_language: Language | None = None
    ...
    def _extract_base_types_from_jsdoc(self, type_str: str) -> list[str]:
        import re
