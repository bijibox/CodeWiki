...
class TreeSitterTSAnalyzer:
    ...
    def analyze(self) -> None:
        ...
        try:
            ...
            all_entities: dict[str, dict[str, object]] = {}
    ...
    def _extract_all_entities(
        self, node, all_entities: dict[str, dict[str, object]], depth: int = 0
    ) -> None:
        ...
        name_obj = entity.get("name") if entity else None
        if entity and isinstance(name_obj, str):
            entity_name = name_obj
            entity["depth"] = depth
            entity["node"] = node
    ...
    def _extract_ambient_declaration_entity(self, node, depth: int) -> dict[str, object]:
        name = ""
        for child in node.children:
    ...
    def _extract_arrow_function_entity(self, node, depth: int) -> dict[str, object] | None:
    ...
    def _extract_method_entity(self, node, depth: int) -> dict[str, object] | None:
    ...
    def _extract_class_entity(self, node, class_type: str, depth: int) -> dict[str, object] | None:
    ...
    def _extract_interface_entity(self, node, depth: int) -> dict[str, object] | None:
    ...
    def _extract_type_alias_entity(self, node, depth: int) -> dict[str, object] | None:
        name_node = self._find_child_by_type(node, "type_identifier")
        if not name_node:
            return None
    ...
    def _extract_enum_entity(self, node, depth: int) -> dict[str, object] | None:
        name_node = self._find_child_by_type(node, "identifier")
        if not name_node:
            return None
    ...
    def _extract_variable_entity(self, node, depth: int) -> dict[str, object] | None:
        name_node = self._find_child_by_type(node, "identifier")
        if not name_node:
            return None
    ...
    def _extract_export_statement_entity(self, node, depth: int) -> dict[str, object] | None:
        code_snippet = self._get_node_text(node)
    ...
    def _extract_lexical_declaration_entity(self, node, depth: int) -> dict[str, object] | None:
    ...
    def _extract_variable_declaration_entity(self, node, depth: int) -> dict[str, object] | None:
        var_declarator = self._find_child_by_type(node, "variable_declarator")
        if not var_declarator:
            return None
