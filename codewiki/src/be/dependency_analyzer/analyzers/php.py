...
class TreeSitterPHPAnalyzer:
    ...
    def _extract_type_name(self, type_node) -> Optional[str]:
        ...
        if type_node.type == "named_type":
            ...
            if name_node:
                return cast(str, name_node.text.decode())
        elif type_node.type in ("name", "qualified_name"):
            return cast(str, type_node.text.decode())
        ...
        return cast(str, type_node.text.decode()) if hasattr(type_node, "text") else None
    ...
    def _get_preceding_docstring(self, node, lines: List[str]) -> str:
        ...
        if prev_sibling and prev_sibling.type == "comment":
            comment_text = cast(str, prev_sibling.text.decode())
