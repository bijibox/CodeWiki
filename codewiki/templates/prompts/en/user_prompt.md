...
* IMPORTANT: Write the resulting documentation in English. Leave code identifiers, file names, paths, commands, and other literal/code tokens in their original form.
